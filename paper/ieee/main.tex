...
Sprint 7 adds a compiler-independent program-header matrix, and Sprint 8 Patch 030 expands it to fourteen valid layouts and ten malformed layouts. The matrix fixes expected PIE, NX-stack, RELRO-presence, dynamic-linking, bind-now, dynamic-table count and terminator, RWX-load, load-count, executable-region behavior, selected table-end overflow rejection, and bounded dynamic-table rejection. These tests provide regression evidence for represented cases, not a proof of complete mitigation coverage or memory safety.
