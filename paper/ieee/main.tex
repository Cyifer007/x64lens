...
Sprint 7 adds a compiler-independent program-header matrix with eleven valid layouts and seven malformed layouts after the checked table-arithmetic refactor. The matrix fixes expected PIE, NX-stack, RELRO-presence, dynamic-linking, RWX-load, load-count, executable-region behavior, and selected table-end overflow rejection. These tests provide regression evidence for represented cases, not a proof of complete mitigation coverage or memory safety.
