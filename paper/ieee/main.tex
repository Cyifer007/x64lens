...
Sprint 7 adds a compiler-independent program-header matrix with eleven valid layouts and five malformed layouts. The matrix fixes expected PIE, NX-stack, RELRO-presence, dynamic-linking, RWX-load, load-count, and executable-region behavior before checked parser arithmetic is consolidated. These tests provide regression evidence for represented cases, not a proof of complete mitigation coverage or memory safety.
