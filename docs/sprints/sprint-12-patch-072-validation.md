...
in the [Patch 087 validation record](sprint-13-patch-087-validation.md).
...
complete Patch 088 acceptance remain pending.
...
accepted; complete Patch 088 acceptance remains pending, so Sprint 12 remains open.
