...
in the [Patch 083 validation record](sprint-13-patch-083-validation.md).
...
complete Patch 083 acceptance remain pending.
...
accepted; complete Patch 083 acceptance remains pending, so Sprint 12 remains open.
