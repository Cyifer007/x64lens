...
- Recursive delivery manifests reject missing, extra, linked, special, unsafe,
  undeclared empty-directory, mode-changed, size-changed, or hash-changed
  members.
- Source delivery is generated from the exact Git candidate tree and excludes
  ignored private/generated state.
