...
review required Patch 081, which was not accepted. Patch 082 is the current
candidate. The batch pilot, private-fact matrix, and `readelf`
...
[`sprint-13-patch-082-validation.md`](sprint-13-patch-082-validation.md).
