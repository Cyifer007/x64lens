...
[Patch 085 validation record](sprint-13-patch-085-validation.md).
...
and 082 were not accepted. Patches 083 and 084 also did not complete acceptance;
Patch 085 is the current exact-source implementation candidate. Complete
acceptance remains pending against the exact P085 source.
Current validation expectations are in the
[Patch 085 validation record](sprint-13-patch-085-validation.md). Patch 079's
