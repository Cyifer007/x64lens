...
[Patch 088 validation record](sprint-13-patch-088-validation.md).
...
and 082 were not accepted. Patches 083 through 087 did not complete acceptance;
Patch 089 is the current exact-source implementation candidate. Complete
acceptance remains pending against the exact P088 source.
Current validation expectations are in the
[Patch 088 validation record](sprint-13-patch-088-validation.md). Patch 079's
