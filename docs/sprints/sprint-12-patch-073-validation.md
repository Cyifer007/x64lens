...
and 082 were not accepted. Patches 083 through 088 did not complete acceptance;
Patch 089 is the current exact-source implementation candidate. Complete
acceptance remains pending against the exact P089 source.
Current validation expectations are in the
[Patch 089 validation record](sprint-13-patch-089-validation.md). Patch 079's
