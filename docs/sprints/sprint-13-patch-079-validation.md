...
Historical candidate. Patch 078 was superseded by the Patch 079 correction and private
task-value gate; Patch 079 was superseded by Patch 080, and Patch 080 by Patch 081.
Patches 081 and 082 were not accepted. Patches 083 and 084 also did not complete
acceptance; Patch 085 is the current exact-source implementation candidate, pending
...
becomes active only after complete Patch 085 acceptance against the exact
candidate source.
