...
further correction, Patch 066 required Patch 067, and Patch 067 required the
current Patch 068 corrective candidate. Use the
...
last historical candidate boundary.
