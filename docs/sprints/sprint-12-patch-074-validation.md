...
are in the [Patch 087 validation record](sprint-13-patch-087-validation.md).
...
superseded by Patch 080, which was superseded by Patch 081. Patches 081 through 086 did
not complete acceptance. Patch 088 is the current exact-source implementation candidate.
Complete acceptance remains pending against the exact P087 source. The historical Patch
