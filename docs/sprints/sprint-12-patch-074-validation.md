...
are in the [Patch 089 validation record](sprint-13-patch-089-validation.md).
...
superseded by Patch 080, which was superseded by Patch 081. Patches 081 through 088 did
not complete acceptance. Patch 089 is the current exact-source implementation candidate.
Complete acceptance remains pending against the exact P089 source. The historical Patch
074 candidate does not close Sprint 12 or
