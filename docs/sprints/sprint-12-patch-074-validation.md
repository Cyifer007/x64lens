...
are in the [Patch 088 validation record](sprint-13-patch-088-validation.md).
...
superseded by Patch 080, which was superseded by Patch 081. Patches 081 through 087 did
not complete acceptance. Patch 089 is the current exact-source implementation candidate.
Complete acceptance remains pending against the exact P088 source. The historical Patch
