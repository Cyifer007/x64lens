...
Patch 027 should consolidate checked addition, multiplication, table-extent, and offset-plus-length validation while preserving this oracle unchanged. Later mitigation work should add GNU property notes, stack-canary evidence, and richer RELRO distinctions only with corresponding fixture rows and output-contract updates.
