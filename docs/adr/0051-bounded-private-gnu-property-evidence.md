...
[Patch 083 validation record](../sprints/sprint-13-patch-083-validation.md).
...
- Patch 069 added authenticated external reconciliation without changing public
  ...
  gate as `defer`. Patches 081 and 082 were not accepted; Patch 083 is the current
  exact-source implementation candidate, and any future public field requires
