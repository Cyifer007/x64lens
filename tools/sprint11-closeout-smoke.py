...
def main() -> int:
    try:
        ...
        require("Patch 087 correction and paired workload/phase-attribution authority candidate, pending complete acceptance" in sprint12, "Sprint 12 continuation chronology is missing")
