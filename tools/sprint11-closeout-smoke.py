...
def main() -> int:
    try:
        ...
        require("Patch 082 corrective and exact-source acceptance candidate, pending complete acceptance" in sprint12, "Sprint 12 continuation chronology is missing")
