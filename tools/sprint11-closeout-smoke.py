...
def main() -> int:
    try:
        ...
        require("Patch 089 correction and split-debug/workload evidence candidate, pending complete acceptance" in sprint12, "Sprint 12 continuation chronology is missing")
