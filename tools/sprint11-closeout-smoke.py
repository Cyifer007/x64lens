...
def main() -> int:
    try:
        ...
        require("Patch 088 correction and split-debug packaging experiment candidate, pending complete acceptance" in sprint12, "Sprint 12 continuation chronology is missing")
