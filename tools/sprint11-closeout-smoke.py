...
def main() -> int:
    try:
        ...
        require("Patch 085 corrective, frozen replay, and terminal-attribution candidate, pending complete acceptance" in sprint12, "Sprint 12 continuation chronology is missing")
