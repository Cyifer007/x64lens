...
grep -q '^Patch 083 corrective and exact-source acceptance candidate, pending complete acceptance' docs/sprints/sprint-12-plan.md \
    || fail 'Sprint 12 is not marked as the Patch 083 corrective and exact-source acceptance candidate'
grep -q '^Patch 083 natural coordinate campaign candidate; activation pending complete Patch 083 acceptance' docs/sprints/sprint-13-plan.md \
    || fail 'Sprint 13 is not marked as the Patch 083 natural coordinate campaign candidate'
