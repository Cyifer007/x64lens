...
python3 "$ROOT_DIR/tools/validate-json-report.py" --mode "$MODE" --require-schema 0.2.0 --expected-command analyze --require-provenance --require-sprint10-effects "$TMP_JSON"
