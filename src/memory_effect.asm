...
.materialize_write:
    ...
    jne     .bounds_error
    cmp     qword [r12 + GADGET_SIDE_EFFECT_FLAGS], SIDE_EFFECT_STACK_READ | SIDE_EFFECT_MEMORY_WRITE | SIDE_EFFECT_CONTROL_TRANSFER
    jne     .bounds_error
...
.materialize_read:
    ...
    cmp     qword [r12 + GADGET_STACK_DELTA], STACK_DELTA_RET
    jne     .bounds_error
    cmp     qword [r12 + GADGET_SIDE_EFFECT_FLAGS], SIDE_EFFECT_STACK_READ | SIDE_EFFECT_MEMORY_READ | SIDE_EFFECT_REGISTER_WRITE | SIDE_EFFECT_CONTROL_TRANSFER
    jne     .bounds_error
