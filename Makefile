...
$(BINARY_ROLE_RECONCILIATION_BIN): $(BINARY_ROLE_RECONCILIATION_OBJ) $(BUILD_DIR)/binary_role.o $(BUILD_DIR)/phdr.o $(BUILD_DIR)/regions.o $(BUILD_DIR)/bounds.o
	$(LD) $(LDFLAGS) -o $@ $^
